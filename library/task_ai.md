...
- [ ] 9.6.1. Завершить замену компонентов Ant Design на собственные реализации:
  ...
  - [ ] BooksPage.tsx - требуется рефакторинг
  - [ ] Админ-панель - требуется рефакторинг:
    - [ ] AdminDashboard.tsx
    - [ ] AdminBooks.tsx
    - [ ] AdminCategories.tsx
- [ ] 9.6.2. Необходимо заменить компоненты от @ant-design/icons на компоненты react-icons
- [ ] 9.6.3. Разработать и интегрировать недостающие компоненты:
  - [ ] Rate - для рейтинга книг
  - [ ] Space - для управления отступами между компонентами
