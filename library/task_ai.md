...
- [ ] 3.3. Улучшение страницы книг по категории
  - [ ] 3.3.1. Дизайн и верстка страницы книг по категории
    - [ ] 3.3.1.1. Добавление хлебных крошек для навигации по категориям
    - [ ] 3.3.1.2. Улучшение отображения списка книг выбранной категории
    - [ ] 3.3.1.3. Добавление возможности переключения между представлениями (сетка/список)
    - [ ] 3.3.1.4. Добавление сортировки книг по различным параметрам (название, автор, дата)
  - [ ] 3.3.2. Интеграция с API бэкенда
    - [ ] 3.3.2.1. Получение книг по выбранной категории с использованием API
    - [ ] 3.3.2.2. Реализация фильтрации книг в рамках категории
    - [ ] 3.3.2.3. Реализация сортировки книг внутри категории
    - [ ] 3.3.2.4. Добавление пагинации для навигации по списку книг категории
  - [ ] 3.3.3. Оптимизация пользовательского опыта
    - [ ] 3.3.3.1. Сохранение выбранных фильтров и сортировки при навигации
    - [ ] 3.3.3.2. Добавление состояний загрузки при переключении фильтров
    - [ ] 3.3.3.3. Улучшение адаптивного дизайна для различных устройств
